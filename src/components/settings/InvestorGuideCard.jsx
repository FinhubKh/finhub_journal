...
const STEPS = [
  {
    ...
    desc: 'In Finhub open Accounts. Add a trading account (choose MetaTrader 4 or 5), or use one you already have.',
  ...
  },
  {
    ...
    desc: 'In MetaTrader 4 or 5, open your account details and copy the investor (read-only) password — not the master password.',
  ...
  },
  {
    ...
    desc: 'On the account card, open Investor password sync. Choose your broker, pick the MT4/MT5 server, then enter login and investor password.',
    tip: 'Use the exact server name from the MetaTrader login box (e.g. Exness-MT5Real36 or ICMarkets-Demo).',
    action: 'accounts',
  },
  {
    n: 4,
    title: 'Sync your closed trades',
    desc: 'Save credentials, then use Sync Now. Closed trades pull into your journal — no EA install required for investor sync.',
